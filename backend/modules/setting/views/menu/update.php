            ...
            <div class="panel-body">
                <form class="form-horizontal" id="addForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label><input type="radio" name="type" <?php if (isset($menu['type']) && $menu['type'] == '1') echo 'checked'; ?> value="1"/>普通菜单</label>
                                <label><input type="radio" name="type" <?php if (isset($menu['type']) && $menu['type'] == '2') echo 'checked'; ?> value="2"/>权限菜单</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="radio">
                                <label><input type="radio" name="status" <?php if (isset($menu['status']) && $menu['status'] == '0') echo 'checked'; ?> value="0"/>启用</label>
                                <label><input type="radio" name="status" <?php if (isset($menu['status']) && $menu['status'] == '1') echo 'checked'; ?> value="1"/>禁用</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
